# Stop sign detection dataset (1800 images) with support for y-axis

# Body

Stop sign detection dataset (stop sign) 1800 images, support Yolo
Electronic version of the dataset, suitable for learning and research, clear pictures, standard format, suitable for tasks such as object detection and classification.
just order it, details can be privately asked to me.
